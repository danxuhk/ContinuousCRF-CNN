...
class Multilabel_Data_Layer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        if self.phase == TRAIN and len(top) != 2:
            raise Exception("Wrong number of top blobs (img, seg)")
    ...
    def forward(self, bottom, top):
        ...
        for itt in range(self.batch_size):
            ...
            im, label_seg = self.batch_loader.load_next_sample()
...
class BatchLoader(object):
    ...
    def load_next_sample(self):
        ...
        self._cur += 1
        return self.transformer.preprocess(img, seg, self.scale)
